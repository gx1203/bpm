  ...
  <el-dialog title="选择组织" class="person_list" :visible.sync="dialogVisible" width="70%" :close-on-click-modal = false :close-on-press-escape = false>
    <el-row :gutter="20" class="group_container">
      ...
      <el-col :span="15">
        <el-row>
          <el-col :span="24">
            <el-input placeholder="请输入内容" class="search_component" v-model="keyWords" clearable @keyup.13.native = "singleSearch">
              <el-button type="primary" slot="append" @click="singleSearch">搜索</el-button>
            </el-input>
          </el-col>
        </el-row>
        <el-table :data="userList" border class="main_tab">
