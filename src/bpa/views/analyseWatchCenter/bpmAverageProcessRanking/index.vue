      ...
      <el-col :span="24">
        <div class="chartsBg">
          <div class="pieTitle flexBox">
            <h4>{{$t("averageProcessingTimeRanking")}}</h4>
          </div>
            ...
            <el-row class="bpaPostDetails-bottom">
              ...
              <el-col :span="24" style="margin-top:20px;">
                ...
                >
                  ...
                  <el-table-column prop="averagetime" :label="averageProcessingTime" sortable />
                </el-table>
                <el-pagination
...
export default {
  ...
  data() {
    return {
      ...
      exportdata: {
        tHeader: ['流程名称', '平均处理时长'],
        filterVal: ['processnamecn', 'averagetime'],
        exportdata: [],
        filename: '平均处理时长排名'
      },
      pagesData: {
      ...
      averageProcessingTime:this.$t("averageProcessingTime"),
    }
  },
  computed: {},
  mounted() {
  ...
  methods: {
    ...
    Excelexport() {
      ...
      getExportPostAverageTime(obj).then(res => {
