            ...
            <el-scrollbar class="right-content1">
              ...
              <div v-if="nodeCode">
                <el-row class="right-base">
                  <el-col :span="24" class="margin-b15">
                    <span>指标编码</span>
                    <el-input v-model="updateForm.kpicode" disabled></el-input>
                  </el-col>
                  <el-col :span="24" class="margin-b15">
                    <span>指标名称</span>
                    <el-input v-model="updateForm.kpiname"  disabled></el-input>
                  </el-col>
                  <el-col :span="24" class="margin-b15">
                    <span style="margin-bottom: 29px;">描述</span>
                    <el-input v-model="updateForm.description"  type="textarea" disabled></el-input>
                  </el-col>
                  <el-col :span="24" class="margin-b15">
                    <span>KPI值</span>
                    <el-input v-model="updateForm.exname"  disabled></el-input>
                  </el-col>
                  <el-col :span="24" class="margin-b15">
                    <span>计划值1</span>
                    <el-input v-model="updateForm.pvalue1"  disabled></el-input>
                  </el-col>
                  <el-col :span="24" class="margin-b15">
                    <span>计划值2</span>
                    <el-input v-model="updateForm.pvalue2" disabled></el-input>
                  </el-col>
                  <el-col :span="24" class="margin-b15">
                    <span>阈值(MinMax）</span>
                    <el-input v-model="updateForm.threshold" disabled></el-input>
                  </el-col>
                  <el-col :span="24" class="margin-b15">
