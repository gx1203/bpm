    ...
    <el-main class="mainChart">
      ...
      <el-row :span="24" class="dashboard">
        <el-col :span="6" class="h100">
          <ul class="w100 h100">
            <li class="w100 h33 cursor-pointer relative" @mouseover.stop="showvaries.child1 = true" @mouseout.stop="showvaries.child1 = false" @click.stop="toDetail(childrenChartId[0])">
            ...
            <li class="w100 h33 cursor-pointer relative" @mouseover.stop="showvaries.child3 = true" @mouseout.stop="showvaries.child3 = false"  @click.stop="toDetail(childrenChartId[2])">
            ...
            <li class="w100 h34 cursor-pointer relative" @mouseover.stop="showvaries.child5 = true" @mouseout.stop="showvaries.child5 = false" @click.stop="toDetail(childrenChartId[4])">
        ...
        <el-col :span="6" class="h100">
          <ul class="h100">
            <li class="w100 h33 cursor-pointer relative" @mouseover.stop="showvaries.child2 = true" @mouseout.stop="showvaries.child2 = false" @click.stop="toDetail(childrenChartId[1])">
            ...
            <li class="w100 h33 cursor-pointer relative" @mouseover.stop="showvaries.child4 = true" @mouseout.stop="showvaries.child4 = false" @click.stop="toDetail(childrenChartId[3])">
            ...
            <li class="w100 h34 cursor-pointer relative" @mouseover.stop="showvaries.child6 = true" @mouseout.stop="showvaries.child6 = false" @click.stop="toDetail(childrenChartId[5])">
