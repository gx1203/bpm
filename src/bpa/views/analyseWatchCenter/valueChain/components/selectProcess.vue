<template>
  <el-dialog title="选择流程" class="person_list" :visible.sync="dialogVisible" width="50%"
  ...
  >
    ...
    <span slot="footer" class="dialog-footer">
      <el-button @click="dialogVisible = false;$emit('input', false)">取消</el-button>
...
<script>
import { getProcessIframeTree, searchProcessIframeTree } from '@/bpa/api/componentsApi'
export default {
  name: 'selectProcess',
  data() {
    return {
