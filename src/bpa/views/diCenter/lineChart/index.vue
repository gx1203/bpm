<template>
  <div id="database">
    <el-main class="di__main">
        <el-row>
         <el-button class="goBack" @click="$router.push('/analyseWatchCenter/bpaPostDetails')">返回上一级</el-button>
        </el-row>
        <el-row>
          <el-col style="text-align:center">
              <el-button type="primary" :class="{'active':!showlist }" plain @click="clickshow('chart')">图</el-button>
              <el-button type="primary" :class="{'active':showlist }" plain @click="clickshow('list')">表</el-button>
            </el-col>
        </el-row>
        <div class="showContent" id="myChart" v-show="!showlist"></div>
        <div class="showContent" v-show="showlist">
          <el-table :data="tableData2" size="small">
            ...
            <el-table-column prop="ValueChainName" label="价值链阶段名称" align= "center"></el-table-column>
          ...
          <el-pagination small background layout="prev, pager, next, jumper, total" :total="8"></el-pagination>
        </div>
    </el-main>
  </div>
</template>
