<template>
  <div class="w100" id="edgeToedge" @click="rightContextMenu = false">
          ...
          <div class="content">
            ...
            >
              <div class="realChart" ref="kongtiao">
                <div
                :class="[index == 0 ? 'stageContent stageContent-red' : 'stageContent margin-l10',{'worse': index % 2 == 0}]"
    ...
    <!-- 添加价值链 -->
    <el-dialog title="价值链" :visible.sync="dialogVisible" width="40%">
    ...
    <!-- 添加阶段 -->
    <el-dialog title="阶段" :visible.sync="stagedialogVisible" width="40%">
  ...
  .paintChart {
    ...
    .content {
      ...
      .realChart {
        ...
        .stageContent:nth-child(3) {
          .stageprocessUp {
            .stageprocessmore:nth-child(2) {
              color: #fb1c1c;
              span {
