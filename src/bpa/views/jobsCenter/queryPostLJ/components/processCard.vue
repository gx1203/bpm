    ...
    >
      ...
      <el-tabs v-model="editableTabsValue" type="border-card" @tab-click="tabsClick">
            ...
            >
              ...
              <el-row :gutter="10">
                ...
                <el-col :span="12" v-if="existTabField('c_fictitiousPerson', 'refer')">
                  ...
                  >
                    <el-input clearable v-model="attrsForm.singer" disabled></el-input>
                  </el-form-item>
                </el-col>
                <!-- 版本 -->
                <el-col :span="12" v-if="existTabField('c_versions', 'refer')">
                  ...
                  >
                    <el-input clearable v-model="attrsForm.versions" disabled></el-input>
                  </el-form-item>
                </el-col>
                <!-- 层级 -->
                <el-col :span="12" v-if="existTabField('c_processLevel', 'refer')">
                  ...
                  >
                    <el-input clearable v-model="attrsForm.level" disabled></el-input>
                  </el-form-item>
                </el-col>
                <!-- 流程框架编码 -->
                <el-col :span="12" v-if="existTabField('c_processCoding', 'refer')">
                  ...
                  >
                    <el-input clearable v-model="attrsForm.code" disabled></el-input>
                  </el-form-item>
                </el-col>
                <!-- 生效日期 -->
                  ...
                  >
                    ...
                    >
                      <el-col :span="5">
                        ...
                        >
                          <span class="el-dropdown-link">
                            <el-input clearable v-model.lazy="obj.term"></el-input>
                          </span>
                      ...
                      <el-col :span="16" class="padding-l10px">
                        <el-input clearable v-model="obj.termdetail"></el-input>
                      </el-col>
                ...
                <el-col :span="24" v-if="existTabField('c_scope', 'refer')">
                  ...
                  >
                    <el-input clearable v-model="attrsForm.fitscope"></el-input>
                  </el-form-item>
                </el-col>
                <!-- 负责部门 -->
              ...
              <el-row :gutter="10">
                ...
                <el-col :span="12" v-if="existTabField('c_ruleName', 'refer')">
                  ...
                  >
                    <el-input clearable v-model="attrsForm.rulename" disabled></el-input>
                  </el-form-item>
                </el-col>
                <!-- 制度编码 -->
                <el-col :span="12" v-if="existTabField('c_ruleCode', 'refer')">
                  ...
                  >
                    <el-input clearable v-model="attrsForm.rulecode" disabled></el-input>
                  </el-form-item>
                </el-col>
                <!-- 制度编写人 -->
                ...
                <el-col :span="12" v-if="existTabField('c_ruledes', 'refer')">
                  ...
                  >
                    <el-input clearable v-model="attrsForm.ruledesc" type="textarea"></el-input>
                  </el-form-item>
                </el-col>
                <!-- 制度原因 -->
                <el-col :span="12" v-if="existTabField('c_rulereason', 'refer')">
                  ...
                  >
                    <el-input clearable v-model="attrsForm.rulereason" type="textarea"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              ...
              <el-row :gutter="10">
                ...
                <el-col :span="12" v-if="existTabField('c_processName', 'refer')">
                  ...
                  >
                    <el-input clearable v-model="attrsForm.processname" disabled></el-input>
                  </el-form-item>
                </el-col>
                <!-- 流程编码 -->
                <el-col :span="12" v-if="existTabField('code_processCoding', 'refer')">
                  ...
                  >
                    <el-input clearable v-model="processcode" disabled></el-input>
                  </el-form-item>
                </el-col>
                <!-- 流程负责人 -->
                ...
                <el-col :span="12" v-if="existTabField('c_issuer', 'refer')">
                  ...
                  >
                    <el-input clearable v-model="attrsForm.upowner" disabled></el-input>
                  </el-form-item>
                </el-col>
                <!-- 流程描述 -->
                <el-col :span="12" v-if="existTabField('c_processDescription', 'refer')">
                  ...
                  >
                    <el-input clearable v-model="attrsForm.desc" type="textarea"></el-input>
                  </el-form-item>
                </el-col>
                <!-- 流程目的 -->
                <el-col :span="12" v-if="existTabField('c_target', 'refer')">
                  ...
                  >
                    <el-input clearable v-model="attrsForm.target" type="textarea"></el-input>
                  </el-form-item>
                </el-col>
                <!-- 起点==================================================================== -->
                <el-col :span="12" v-if="existTabField('c_origin', 'refer')">
                  ...
                  >
                    <el-input clearable v-model="attrsForm.startpoint" :title="attrsForm.startpoint" disabled></el-input>
                  </el-form-item>
                </el-col>
                <!-- 终点================================================================================= -->
                <el-col :span="12" v-if="existTabField('c_endpoint', 'refer')">
                  ...
                  >
                    <el-input clearable v-model="attrsForm.endpoint" :title="attrsForm.endpoint" disabled></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row :gutter="10">
        ...
        <el-tab-pane name="11" :label="existTab('11')" v-if="existTab('11','refer')">
          <correlation-support :modelid="modelid" :bpmid="bpmid" :treeId="treeId" :version="version" v-if="editableTabsValue == 11"></correlation-support>
        </el-tab-pane>
        <!-- 业务规则 -->
        <el-tab-pane name="5" :label="existTab('5')" v-if="existTab('5','refer')">
          <busRule :showtabfiled="showtabfiled" :modelid="modelid" />
        </el-tab-pane>
        <!-- 修订内容 -->
    ...
    >
      ...
      >
        <el-form-item class="label-height-auto" label="描述:" prop="desc">
          <el-input clearable type="textarea" v-model="selectInoutform.desc" rows="4" resize="none"></el-input>
        </el-form-item>
        <el-form-item
          class="label-height-auto"
  ...
  methods: {
    ...
    handlerSelect(obj) {
      ...
      obj.uploadfiles.map(item => {
        if ( this.selectReferType === 'processInput' || this.selectReferType === 'processOutput' ) {
