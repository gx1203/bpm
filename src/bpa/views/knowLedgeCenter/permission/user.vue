  ...
  <el-container class="msg-conten">
    ...
    <el-aside width="85%" style="padding: 10px;">
      ...
      <transition name="el-zoom-in-top">
        <div v-if="isShow" class="msg-form">
          <el-form
            ...
            <el-form-item label="权限范围" prop="name2">
              <el-checkbox-group v-model="ruleForm1.name2">
                <el-checkbox label="维度查看" name="name2" />
      ...
      <el-table
        ...
        <el-table-column prop="wdstate" label="维度查看" sortable width="100" />
        <el-table-column prop="zsstate" label="知识上传" sortable width="100" />
      </el-table>
      <portal-pagination
    ...
    fun() {
      getComments({
        ...
        .then(res => {
          ...
          this.tableData = res.data.userDimensionlist
