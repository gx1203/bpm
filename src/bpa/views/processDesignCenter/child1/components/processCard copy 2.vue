    ...
    >
      ...
      <el-tabs v-model="editableTabsValue" type="border-card" @tab-click="tabsClick">
        ...
        <el-tab-pane name="9" :label="existTab('9')" v-if="existTab('9','refer')">
          <author :treeId="treeId" v-if="editableTabsValue == 9"></author>
        </el-tab-pane>
        <!-- 相关性支撑内容 -->
        <el-tab-pane name="11" :label="existTab('11')" v-if="existTab('11','refer')">
          <correlation-support :treeId="treeId" v-if="editableTabsValue == 11"></correlation-support>
        </el-tab-pane>
        <!-- 业务规则 -->
...
export default {
  ...
  methods: {
    ...
    deltarget() {
      ...
      this.$confirm('确认要删除选中的绩效吗?', this.$t('hintText.hint'), {
        confirmButtonText: this.$t('confirm'),
        cancelButtonText: this.$t('cancel'),
        type: 'warning'
      })
    ...
    delRule() {
      ...
      this.$confirm('确认要删除选中的规则吗?', this.$t('hintText.hint'), {
        confirmButtonText: this.$t('confirm'),
        cancelButtonText: this.$t('cancel'),
        type: 'warning'
      })
