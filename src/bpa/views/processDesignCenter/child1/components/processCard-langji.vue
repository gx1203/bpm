  ...
  <div class="w100">
    ...
    >
      ...
      <el-tabs v-model="editableTabsValue" type="border-card" @tab-click="tabsClick">
        ...
        <el-tab-pane name="0" :label="existTab('0')" v-if="existTab('0','refer')">
          <div>
            ...
            >
              ...
              <el-row :gutter="20">
                <!-- 模块 -->
                <el-col :span="12" v-if="existTabField('c_modules', 'refer')">
                  <el-form-item
                    :label="existTabField('c_modules')"
                    prop="modules"
                    :rules="[
                    { required: existTabField('c_modules', 'necessary'), message: ' ', trigger: 'blur' }
                  ]"
                  >
                    <el-input v-model="attrsForm.modules" disabled></el-input>
                  </el-form-item>
                </el-col>
                <!-- 层级 -->
              ...
              <el-row :gutter="10">
                <!-- 管理标准类型 -->
                <el-col :span="12" v-if="existTabField('manageTypes', 'refer')">
                  <el-form-item
                    :label="existTabField('manageTypes')"
                    prop="manageTypes"
                    :rules="[
                    { required: existTabField('manageTypes', 'necessary'), message: ' ', trigger: 'blur' }
                  ]"
                  >
                    <el-select
                ...
                <!-- 管理标准归类 -->
                <el-col :span="12" v-if="existTabField('manageClassification', 'refer')">
                  <el-form-item
                    :label="existTabField('manageClassification')"
                    prop="manageClassification"
                    :rules="[
                    { required: existTabField('manageClassification', 'necessary'), message: ' ', trigger: 'blur' }
                  ]"
                  >
                    <el-select
                ...
                <!-- 关键活动补充说明 -->
                <el-col :span="12" v-if="existTabField('supactivities', 'refer')">
                  <el-form-item
                    :label="existTabField('supactivities')"
                    prop="supactivities"
                    :rules="[
                    { required: existTabField('supactivities', 'necessary'), message: ' ', trigger: 'blur' }
                  ]"
                  >
                    <el-input v-model="attrsForm.supactivities"></el-input>
                  </el-form-item>
                </el-col>
                <!-- 流程框架名称 -->
                <el-col :span="12" v-if="existTabField('processframeworkname', 'refer')">
                  <el-form-item
                    :label="existTabField('processframeworkname')"
                    prop="processframeworkname"
                    :rules="[
                    { required: existTabField('processframeworkname', 'necessary'), message: ' ', trigger: 'blur' }
                  ]"
                  >
                    <el-input v-model="attrsForm.processframeworkname"></el-input>
                  </el-form-item>
                </el-col>
                <!-- 生效日期 -->
              ...
              <el-row :gutter="10">
                <!-- 配合部门 -->
                <el-col :span="24" v-if="existTabField('c_codept', 'refer')">
                  <el-form-item
        ...
        <!-- 规章制度管理 -->
        <el-tab-pane name="13" :label="existTab('13')" v-if="existTab('13','refer')">
          <ruleSystem
...
export default {
  ...
  watch: {
    ...
    modules(newValue, oldValue) {
      ...
      this.attrsForm.modules = newValue
    ...
    getProcessAttr() {
      ...
      Promise.all([
        ...
        this.attrsForm = Object.assign({}, this.attrsForm, {
          ...
          manageTypes: resAttr.bpmDto.managetypes != 'null' ? resAttr.bpmDto.managetypes : '', // 管理标准类型:
          manageClassification: resAttr.bpmDto.manageclassification != 'null' ? resAttr.bpmDto.manageclassification : '', // 管理标准归类:
          processframeworkname: resAttr.bpmDto.processframeworkname != 'null' ? resAttr.bpmDto.processframeworkname : '', // 流程框架名称:
          supactivities: resAttr.bpmDto.supactivities != 'null' ? resAttr.bpmDto.supactivities : '', // 关键活动补充说明:
          // 生效时间
