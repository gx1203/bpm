<template>
  <div class="w100">
    ...
    >
      <template slot="title">
        <p class="slotTitle">
          <el-button class="no-border" size="large" type="text" @click="paintChart">绘图</el-button>
          <el-button
            class="no-border"
            size="large"
            type="text"
      ...
      <el-tabs v-model="editableTabsValue" type="border-card" @tab-click="tabsClick">
          ...
          <div>
            ...
            >
              <el-row :gutter="10">
                ...
                <el-col :span="24" v-if="existTabField('c_processResponsible', 'refer')">
                  ...
                  >
                    <el-row>
                      <el-col :span="20">
                        ...
                        <h6 class="margin-t5">上游流程带出输出文件 :</h6>
                      ...
                      <el-col :span="4">
                        <el-button class="float-r" @click="selectprocessfile('processInput')">选择附件</el-button>
                      </el-col>
                    </el-row>
                  </el-form-item>
                </el-col>
                <el-col :span="12" v-if="existTabField('c_processOutput', 'refer')">
                  ...
                  >
                    <el-row>
                      ...
                      <el-col :span="4">
                        <el-button class="float-r" @click="selectprocessfile('processOutput')">选择附件</el-button>
                      </el-col>
                    </el-row>
                  </el-form-item>
                </el-col>
              ...
              <el-row :gutter="10" v-if="existTabField('c_systemClassification', 'refer')">
                <el-col :span="8" class="systemCard margin-b10" v-for="system in syslists" :key="system" v-show="syspart[system].show">
        ...
        <el-tab-pane name="1" :label="existTab('1')" v-if="existTab('1','refer')">
          <div>
            ...
            <el-table :data="supfilelist" border class="main_tab">
              <el-table-column
        ...
        <el-tab-pane name="3" :label="existTab('3')" v-if="existTab('3','refer')">
          <div>
            <el-table :data="risklist" border class="main_tab">
              <el-table-column
                v-if="existTabField('number', 'refer')"
                :label="existTabField('number', '', true)"
                type="index"
        ...
        <el-tab-pane name="4" :label="existTab('4')" v-if="existTab('4','refer')">
          <div>
            <el-table :data="successKeylist" border class="main_tab">
              <el-table-column
                v-if="existTabField('number', 'refer')"
                :label="existTabField('number', '', true)"
                type="index"
        ...
        <el-tab-pane name="5" :label="existTab('5')" v-if="existTab('5','refer')">
          <div>
            ...
            <el-table :data="rulelist" border class="main_tab" @selection-change="handleruleChange">
              <el-table-column type="selection" width="50"></el-table-column>
              <el-table-column
                v-if="existTabField('number', 'refer')"
                :label="existTabField('number', '', true)"
        ...
        <el-tab-pane name="6" :label="existTab('6')" v-if="existTab('6','refer')">
          <div>
            <el-table :data="infolist" border class="main_tab">
              <el-table-column
                v-if="existTabField('number', 'refer')"
                :label="existTabField('number', '', true)"
                type="index"
        ...
        <el-tab-pane name="7" :label="existTab('7')" v-if="existTab('7','refer')">
          <div>
            <el-table :data="recordlist" border class="main_tab">
              <el-table-column
                v-if="existTabField('number', 'refer')"
                :label="existTabField('number', '', true)"
                type="index"
  ...
  data () {
    return {
      ...
      attrsRules: {
        ...
        systemlist: [{ required: true, message: " ", trigger: "blur" }]
      },
      editableTabsValue: 0,
      editableTabs: [],
      selectProcessform: {},
