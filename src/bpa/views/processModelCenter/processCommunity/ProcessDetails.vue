      ...
      <el-col :span="16">
        <div class="left_top">
          ...
          <div class="jpg_wrapper" :class="{'full-show': isFull}">
            ...
            <div class="toolslist">
              <el-tooltip class="item" effect="dark" :content="$t('viewOriginalImage')" placement="right">
                <i class="fa fa-eye" @click.stop="toolclick('eye')"></i>
              </el-tooltip>
              ...
              <el-tooltip class="item" effect="dark" :content="$t('print')" placement="right">
      ...
      <el-col :span="8">
        <div class="right_top">
          ...
          <p class="clear-fix">
            ...
            <span class="float-r more cursor-pointer" style="color: rgb(51, 122, 183);" v-if="docList.length > 1" @click="moreClick()">
              {{ cur ? $t('putAway'):$t('toMore') }}
            </span>
          </p>
          <p class="font-gray file" v-show="!cur" v-if="docList.length > 0">
            <span>
          ...
          <el-scrollbar class="ProcessDocumentation2 clear-fix" v-show="cur">
              ...
              <div class="comment_item">
                ...
                <div class="comment_footer">
                  <div>
                    ...
                    <span
                      class="delete"
                      v-if="item.createid === username || getUserAuthor.indexOf('3') > -1 || getUserAuthor.indexOf('1') > -1"
...
export default {
  ...
  methods: {
    ...
    downloadFile(id) {
      ...
      let self = this
      let aEle = document.createElement('a')
      aEle.setAttribute('href', self.host + self.baseUrl + '/attach/download/' + id + '?username=' + this.processProps2.createby)
      aEle.click()
    },
    // 发表评论
    sendComment() {
    ...
    goBack() {
      this.$router.push({name: 'processCommunity'})
    }
  }
}
</script>
