      ...
      <el-col :span="8">
        <div class="right_top">
          ...
          <p class="ProcessDocumentation clear-fix">
            ...
            <span class="float-r more" style="color: rgb(51, 122, 183);" @click="moreClick()">
    ...
    getProcessProps() {
      getProcessProps(this.id).then(res => {
        ...
        this.processProps.syslist.forEach(item => {
          if (!this.syslists.include(item.typename)) {
