  ...
  <div class="w100">
    ...
    >
      <el-tabs
        ...
        @tab-click="tabsClick"
      >
        <template v-for="(tab, tabindex) in editableTabs">
          <!-- 流程基本属性 -->
          ...
          >
            <div>
              ...
              >
                <!---------------------------------------------- 制度相关信息---------------------->
                <el-row :gutter="10">
                  <template v-for="(col, colndex) in formTabFiled">
                    <!-- 拟制人 -->
                    <el-col
                      v-if="col.pname === 'c_fictitiousPerson'"
                      :span="12"
                      :key="colndex"
                    >
                    ...
                    >
                      ...
                      >
                        <el-input v-model="attrsForm.frameName" :disabled="!isEdit" @focus="selectRuleFrame" />
                      </el-form-item>
                    </el-col>
                    <!-- 制度名称 -->
                    <el-col
                      v-if="col.pname === 'c_systemName'"
                      :span="12"
                      :key="colndex"
                    >
                      <el-form-item
                      ...
                      >
                        <el-input v-model="attrsForm.docTitle" :disabled="!isEdit" />
                      </el-form-item>
                    </el-col>
                    <!-- 制度编码 -->
                    <el-col
                      v-if="col.pname === 'c_systemCode'"
                      :span="12"
                      :key="colndex"
                    >
                      <el-form-item
                      ...
                      >
                        <el-input v-model="attrsForm.systemCode" :disabled="!isEdit" />
                      </el-form-item>
                    </el-col>
                    <!-- 制度编写人 -->
                    <el-col
                      v-if="col.pname === 'c_systemWriter'"
                      :span="12"
                      :key="colndex"
                    >
                      <el-form-item
                    ...
                    <!-- 制度联络人 -->
                    <el-col
                      v-if="col.pname === 'c_systemContactPerson'"
                      :span="12"
                      :key="colndex"
                    >
                      <el-form-item
                    ...
                    <!-- 预留选择人员1 -->
                    <el-col
                      v-if="col.pname === 'reservedPersonField1'"
                      :span="12"
                      :key="colndex"
                    >
                      <el-form-item
                    ...
                    <!-- 预留选择人员2 -->
                    <el-col
                      v-if="col.pname === 'reservedPersonField2'"
                      :span="12"
                      :key="colndex"
                    >
                      <el-form-item
                    ...
                    <!-- 预留选择人员3 -->
                    <el-col
                      v-if="col.pname === 'reservedPersonField3'"
                      :span="12"
                      :key="colndex"
                    >
                      <el-form-item
                    ...
                    <!-- 上级制度 -->
                    <el-col
                      v-if="col.pname === 'c_superiorSystem'"
                      :span="12"
                      :key="colndex"
                    >
                      <el-form-item
                    ...
                    <!-- 制度简介 -->
                    <el-col
                      v-if="col.pname === 'c_systemIntroduction'"
                      :span="12"
                      :key="colndex"
                    >
                      <el-form-item
                    ...
                    <!-- 编制原因 -->
                    <el-col
                      v-if="col.pname === 'c_prepareTheReason'"
                      :span="12"
                      :key="colndex"
                    >
                      <el-form-item
                      ...
                      >
                        <el-input v-model="attrsForm.reason" type="textarea" :disabled="!isEdit" />
                      </el-form-item>
                    </el-col>

                    <!-- 主责部门 -->
                    <el-col
                      v-if="col.pname === 'c_orgname'"
                      :span="12"
                      :key="colndex"
                    >
                      <el-form-item
                    ...
                    <!-- 配合部门 -->
                    <el-col
                      v-if="col.pname === 'c_codistribution'"
                      :span="12"
                      :key="colndex"
                    >
                      <el-form-item
                    ...
                    <!-- 体系分类 -->
                    <el-col
                      v-if="col.pname === 'c_classificationSystem'"
                      :span="24"
                      :key="colndex"
                    >
                      <el-form-item
                    ...
                    >
                      ...
                      >
                        <el-input v-model="attrsForm.standby1" :disabled="!isEdit" />
                      </el-form-item>
                    </el-col>
                    <!-- 预留文本框2 -->
                    <el-col
                      v-if="col.pname === 'standby2'"
                      :span="8"
                      :key="colndex"
                    >
                      <el-form-item
                      ...
                      >
                        <el-input v-model="attrsForm.standby2" :disabled="!isEdit" />
                      </el-form-item>
                    </el-col>
                    <!-- 预留文本框3 -->
                    <el-col
                      v-if="col.pname === 'standby3'"
                      :span="8"
                      :key="colndex"
                    >
                      <el-form-item
                      ...
                      >
                        <el-input v-model="attrsForm.standby3" :disabled="!isEdit" />
                      </el-form-item>
                    </el-col>
                    ...
                    >
                      ...
                      >
                        <el-input type="textarea" v-model="attrsForm.standby4" :disabled="!isEdit" />
                      </el-form-item>
                    </el-col>
                    <!-- 预留文本域2 -->
                    <el-col
                      v-if="col.pname === 'standby5'"
                      :span="8"
                      :key="colndex"
                    >
                      <el-form-item
                      ...
                      >
                        <el-input type="textarea" v-model="attrsForm.standby5" :disabled="!isEdit" />
                      </el-form-item>
                    </el-col>
                    <!-- 预留文本域3 -->
                    <el-col
                      v-if="col.pname === 'standby6'"
                      :span="8"
                      :key="colndex"
                    >
                      <el-form-item
                      ...
                      >
                        <el-input type="textarea" v-model="attrsForm.standby6" :disabled="!isEdit" />
                      </el-form-item>
                    </el-col>

                    <!-- 制度文档 -->
                    <el-col
                      v-if="col.pname === 'c_systemDocument'"
                      :span="24"
                      :key="colndex"
                    >
                      <el-form-item
                    ...
                    <!-- 制度编写说明 -->
                    <el-col
                      v-if="col.pname === 'c_systemCompilationNotes'"
                      :span="24"
                      :key="colndex"
                    >
                      <el-form-item
                    ...
                    <!-- 征求意见情况采纳说明 -->
                    <el-col
                      v-if="col.pname === 'c_adoptionNotesForSolicitingComments'"
                      :span="24"
                      :key="colndex"
                    >
                      <el-form-item
                    ...
                    <!-- 条款及依据表 -->
                    <el-col
                      v-if="col.pname === 'c_termsAndConditions'"
                      :span="24"
                      :key="colndex"
                    >
                      <el-form-item
                    ...
                    <!-- 关联流程 -->
                    <el-col
                      v-if="col.pname === 'c_associatedProcess'"
                      :span="24"
                      :key="colndex"
                    >
                      <el-form-item
                      ...
                      >
                        <el-row>
                          <el-button
                            @click="showSelectPublishedProcessDialog"
                            v-if="isEdit"
                          >
                            {{ existTabField("select", "", true) }}
                          </el-button>
                          ...
                          <el-table
                            v-if="attrsForm.relationProcess.length"
                            :data="attrsForm.relationProcess"
                          >
                            <el-table-column
                              type="index"
                              label="序号"
                            ...
                            <el-table-column label="操作">
                              <template v-if="isEdit" #default="{ $index }">
                                <el-button
                                  type="text"
                                  size="mini"
                                  @click="delProcess($index, 'relationProcess')"
          ...
          <el-tab-pane
            v-if="tab.index === 1 && editItem.docId"
            name="1"
            :label="existTab('1')"
            :key="tabindex"
          >
          ...
          <el-tab-pane
            v-if="tab.index === 3 && editItem.docId"
            name="3"
            :label="existTab('3')"
            :key="tabindex"
          >
          ...
          <el-tab-pane
            v-if="tab.index === 4 && editItem.docId"
            name="4"
            :label="existTab('4')"
            :key="tabindex"
          >
          ...
          <el-tab-pane
            v-if="tab.index === 9 && editItem.docId"
            name="9"
            :label="existTab('9')"
            :key="tabindex"
          >
          ...
          <el-tab-pane
            v-if="tab.index === 10 && editItem.docId"
            name="10"
            :label="existTab('10')"
            :key="tabindex"
          >
          ...
          <el-tab-pane
            v-if="tab.index === 11 && editItem.docId"
            name="11"
            :label="existTab('11')"
            :key="tabindex"
          >
    ...
    /> -->
    <!-- 选择已发布流程 -->
    <select-published-process
      :default-checked-nodes="processlists"
      :dialog-visible.sync="publishedProcessDialogVisible"
      @publishedProcessDialogConfirm="publishedProcessDialogConfirm"
    ></select-published-process>
...
import SelectPublishedProcess from '@/bpa/components/SelectPublishedProcess.vue'
...
export default {
  ...
  data() {
    return {
      publishedProcessDialogVisible: false, // 选择已发布流程对话框
      showtype: '',
      groupType: '',
      selectedID: [],
  ...
  methods: {
    // 显示已发布流程对话框
    showSelectPublishedProcessDialog() {
      this.processlists = this.attrsForm.relationProcess
      this.publishedProcessDialogVisible = true
    },
    selectRuleFrame() {
    ...
    deleteSystemCode() {
      console.log(this.attrsForm)
      this.attrsForm.frameName = this.attrsForm.frameName.replace(
        `/${this.attrsForm.frameCode}/`,
        ''
      )
    ...
    getDetails(id) {
      if (id && this.editItem.type !== 'add') {
        getDetails(id).then(async res => {
          if (!res) return false
          this.attrsForm = res
          // 根据流程id查询详细信息
          const processIds = res.relationProcess.map(item => item.id)
          let relationProcess = []
          if (processIds.length) {
            relationProcess = await getProcessDetails(processIds)
            console.log('🐶relationProcess', relationProcess)
          }
          this.attrsForm = Object.assign({}, this.attrsForm, {
            docTitle: res.title,
            docId: res.docId,
    ...
    selectRuleConfirm(list) {
      this.attrsForm[`${this.ruleType}Name`] = list
        .map(item => item.title)
        .join()
      this.attrsForm[`${this.ruleType}`] = list.map(item => item.docId).join()
    },
    ...
    handlerSuccessFile(res) {
      ...
      if (res.code === 200) {
        ...
        this.inDate = res.data.currentDate
    ...
    async getShowTabField(id, type) {
      ...
      this.formTabFiled = res.list.filter(item => item.dicttype === '1' && item.state === '1')
    ...
    saveBooks() {
      const self = this;
      this.$refs.attrsFormRef[0].validate(async(valid) => {
        if (valid) {
          // 主文档验证
          if (
          ...
          const res = await saveBooks({
            ...
            inDate: this.inDate ? this.inDate : getFormateDate(new Date(), "yyyy-MM-dd hh:mm:ss"),
    ...
    async publishedProcessDialogConfirm(selectedNodes) {
      // 根据选中的id查询流程详情
      const processIds = selectedNodes.map(item => item.id)
      const res = await getProcessDetails(processIds)
      this.attrsForm.relationProcess = res
    },
    delProcess(i, type) {
      if (type === 'relationProcess') {
