      ...
      <el-row :gutter="10">
        ...
        <el-col :span="18">
          ...
          <el-row>
            <el-col :span="12">
              <el-input v-model="keyWords" :placeholder="pleaseEnterTitle" :title="pleaseEnterTitle" class="search_component" clearable @keyup.13.native="getList">
                <el-button slot="append" icon="iconfont_search icon-sousuo2" type="primary" @click="pages.pageNum = 1;getList()" />
              </el-input>
            </el-col>
          </el-row>
          <!-- 信息表格 -->
          <el-table
            ...
            <el-table-column :label="$t('systemName1')" prop="title" show-overflow-tooltip />
