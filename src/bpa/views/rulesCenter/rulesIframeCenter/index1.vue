<template>
  <div class="w100 pos-relative" id="processIframeCenter">
    ...
    <div id="process_tree_wrapper" class="process-tree-wrapper" v-show="showProcessTree">
      <div class="toolbox">
        <el-tooltip :open-delay="1000" class="font22 margin-r5" effect="dark" :content="$t('amplification')"  placement="top-start">
          <i class="el-icon-zoom-in cursor-pointer vertical-middle" @click="modifyScreen('zoomIn')"></i>
        </el-tooltip>
        <el-tooltip :open-delay="1000" class="font22 margin-r5" effect="dark" :content="$t('narrow')" placement="top-start">
          <i
        ...
        <el-tooltip :open-delay="1000" class="font22 margin-r5" effect="dark" :content="$t('fullScreen')" placement="top-start">
          <span
            class="el-icon-rank cursor-pointer vertical-middle"
            @click="modifyScreen('fullscreen')"
          ></span>
        </el-tooltip>
        <el-tooltip :open-delay="1000" class="font22 margin-r5" effect="dark" content="返回列表" placement="top-start">
...
import {
  getProcessTree,
  getProcessCount
} from "@/api/processModelCenter/processIframeCenter";
        ...
        if (obj.level == "1") {
          ...
          if (obj.isparent) {
            if (obj.imputlist && obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise01all.png")}`;
            } else if (obj.imputlist && !obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise01in_c.png")}`;
            } else if (!obj.imputlist && obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise01out_c.png")}`;
            } else if (!obj.imputlist && !obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise01c.png")}`;
            }
          } else {
            if (obj.imputlist && obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise01inout.png")}`;
            } else if (obj.imputlist && !obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise01in.png")}`;
            } else if (!obj.imputlist && obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise01inout.png")}`;
            } else if (!obj.imputlist && !obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise01.png")}`;
            }
          }
        } else if (obj.level == "3") {
          if (obj.isparent) {
            if (obj.imputlist && obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise02all.png")}`;
            } else if (obj.imputlist && !obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise02in_c.png")}`;
            } else if (!obj.imputlist && obj.outlist) {
              obj.symbol = "image://./assets/img/enterprise02out_c.png";
            }
            if (!obj.imputlist && !obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise02c.png")}`;
            }
          } else {
            if (obj.imputlist && obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise02inout.png")}`;
            } else if (obj.imputlist && !obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise02in.png")}`;
            } else if (!obj.imputlist && obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise02inout.png")}`;
            } else if (!obj.imputlist && !obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise02.png")}`;
            }
          }
        } else if (obj.level == "4") {
          if (obj.isparent) {
            if (obj.imputlist && obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise03all.png")}`;
            } else if (obj.imputlist && !obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise03in_c.png")}`;
            } else if (!obj.imputlist && obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise03out_c.png")}`;
            } else if (!obj.imputlist && !obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise03c.png")}`;
            }
          } else {
            if (obj.imputlist && obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise03inout.png")}`;
            } else if (obj.imputlist && !obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise03in.png")}`;
            } else if (!obj.imputlist && obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise03inout.png")}`;
            } else if (!obj.imputlist && !obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise03.png")}`;
            }
          }
        } else if (obj.level == "5") {
          if (obj.isparent) {
            if (obj.imputlist && obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise04all.png")}`;
            } else if (obj.imputlist && !obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise04in_c.png")}`;
            } else if (!obj.imputlist && obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise04out_c.png")}`;
            } else if (!obj.imputlist && !obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise04c.png")}`;
            }
          } else {
            if (obj.imputlist && obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise04inout.png")}`;
            } else if (obj.imputlist && !obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise04in.png")}`;
            } else if (!obj.imputlist && obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise04inout.png")}`;
            } else if (!obj.imputlist && !obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise04.png")}`;
            }
          }
        } else if (obj.level == "6") {
          if (obj.isparent) {
            if (obj.imputlist && obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise05all.png")}`;
            } else if (obj.imputlist && !obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise05in_c.png")}`;
            } else if (!obj.imputlist && obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise05out_c.png")}`;
            } else if (!obj.imputlist && !obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise05c.png")}`;
            }
          } else {
            if (obj.imputlist && obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise05inout.png")}`;
            } else if (obj.imputlist && !obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise05in.png")}`;
            } else if (!obj.imputlist && obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise05inout.png")}`;
            } else if (!obj.imputlist && !obj.outlist) {
              obj.symbol = `image://${require("@/assets/img/enterprise05.png")}`;
            }
          }
        }
      });
