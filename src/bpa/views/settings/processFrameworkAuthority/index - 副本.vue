<template>
  <div id="processFrameworkAuthority">
    <el-row>
      <!--左侧组织树-->
      <el-col :span="6">
        ...
        <el-input
          ...
          :title="pleaseEnterEnterpriseProcessArchitecture"
          class="search_component"
          v-model="keyWords"
          clearable
          @keyup.13.native="filterTree"
        >
          <el-button type="primary" slot="append" @click.stop="filterTree">{{
            $t("search")
          }}</el-button>
        </el-input>
        <div class="left_tree_wrapper">
          ...
          >
            <div class="custom-tree-node w100" slot-scope="{ node, data }">
...
<!--        <p class="selectMenu">{{ $t("menu") + selectMenuName }}</p>-->
        <el-tabs v-model="activeName" @tab-click="handleClick">
            ...
            <el-row>
              ...
              <el-col :span="6" :offset="12" class="search_buttons_wrap">
                <el-button
                  ...
                  >{{ $t("addPeopleOrganization") }}</el-button
                >
              </el-col>
            </el-row>
          ...
          <el-tab-pane :label="role" name="role">
            <el-row>
              ...
              <el-col :span="6" :offset="12" class="search_buttons_wrap">
                <el-button type="primary" @click="referMenuSelect('role')">{{
                  $t("addingRoles")
                }}</el-button>
              </el-col>
            </el-row>
            <el-table :data="tableRoleData" stripe class="main_tab">
              <el-table-column :label="number" type="index"></el-table-column>
              <el-table-column
                prop="relatedname"
                :label="characterName"
              ...
              <el-table-column align="center">
                <template slot="header" slot-scope="scope">
                  <el-checkbox
                    :indeterminate="isIndeterminate"
                    v-model="checkRolAdd"
                    :disabled="!selectMenuId || tableRoleData.length == 0"
                    @change="handleCheckAllChange('add')"
                    >{{ $t("add") }}</el-checkbox
                  >
                </template>
