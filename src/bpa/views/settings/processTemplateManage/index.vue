<template>
  <div id="processTemplateManage">
    ...
    <el-dialog :visible.sync="dialogVisible" :title="$t('addProcessTemplate')" width="65%">
...
import {
  ...
  saveProcessTemplateCopy,
  deleteProcessTemplateCopy
} from '@/bpa/api/settings/processTemplateManage'
  ...
  methods: {
    ...
    save () {
      this.$refs['form'].validate(valid => {
        if (valid) {
          ...
          saveProcessTemplateCopy(obj).then(res => {
            this.$message({
              type: 'success',
    ...
    mutipleDleteFiles () {
      ...
      this.$confirm(this.areYouSureYouWantToDeleteInBatches, this.hint, {
        ...
        deleteProcessTemplateCopy(idlist.toString()).then(res => {
          this.$message({
            type: 'success',
    ...
    deleteRow (idliststr) {
      this.$confirm(this.areYouSureDelete, this.hint, {
        ...
        deleteProcessTemplateCopy(idliststr).then(res => {
          this.$message({
            type: 'success',
            message: this.successfullyDelete
          })
