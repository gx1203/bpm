          ...
          <div class="operationEcharts">
            ...
            <div class="processNum">
              <div>
                ...
                <p class="num">{{ weekAddData.weekReleaseTotal }}</p>
                <p>
                  周环比
                  <i v-if="weekAddData.rateStauts==false" class="el-icon-bottom dec" />
                  <i v-if="weekAddData.rateStauts==true" class="el-icon-top up" />
                  {{ weekAddData.weekRate }}
                </p>
              </div>
              <div>
                <p class="processName">本周更新流程数</p>
                <p class="num">{{ weekUpdateData.weekReleaseTotal }}</p>
                <p>
                  周环比
                  <i v-if="weekUpdateData.rateStauts==false" class="el-icon-bottom dec" />
                  <i v-if="weekUpdateData.rateStauts==true" class="el-icon-top up" />
...
import { formatDate, getMonthDays } from '@/bpm/utils/common.js'
// 接口请求部分
import {
  getBpaNum,
  getOneFrameworkList,
