  ...
  <div id="bpmTaskProcessDetails" class="w100 bpaAnalysis">
    <el-row :gutter="20" class="bpmTaskDepartment-top">
      <el-col :span="14">
        ...
        <span>节点类型</span>
        <el-select clearable v-model="Department.approvalValue" :placeholder="$t('placeholderText.pleaseSelect')" @change="approvalSubmit">
          <el-option
            ...
            <el-row class="bpmTaskProcessDetails-bottom">
              ...
              <el-col :span="24" style="margin-top:20px;">
                ...
                >
                  ...
                  />
                  <el-table-column
                    prop="prevaverageduration"
                    label="上期平均时长"
                  />
                  <el-table-column
                    prop="averageincrease"
                    label="平均时长环比增效（百分比)"
                  />
                  <el-table-column
                    prop="reportcount"
                  ...
                  />
                  <el-table-column
                    prop="reportproportion"
                    label="请示报告数量占比"
                  />
                  <el-table-column
                    prop="prevreportcount"
                    label="上期请示报告数量"
                  />
                  <el-table-column
                    prop="reportloopcompare"
                    label="请示报告环比"
                  />
                </el-table>
...
// 接口请求部分
import { getTaskEfficiencyDept, getModel, queryTaskEfficiencyDeptTable, getExportTaskEfficiencyDeptTable } from '@/bpm/api/analyseWatchCenter'
// 应用vuex筛选条件
