    ...
    <el-main class="di__main">
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="申请单号">
                <el-input clearable v-model="searchForm.orderNumber" clearable/>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item :label="$t('processName2')">
                <el-input clearable v-model="searchForm.processName" clearable/>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item :label="$t('subject')">
                <el-input clearable v-model="searchForm.theme" clearable/>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            ...
            <el-col :span="8">
              <el-form-item :label="$t('applicant')">
                <el-input clearable v-model="searchForm.people" clearable/>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="申请状态">
                <el-input clearable v-model="searchForm.application" clearable/>
              </el-form-item>
            </el-col>
          </el-row>
      ...
      <div class="showContent">
        <el-table :data="tableData" size="small">
          ...
          <el-table-column prop="people" :label="$t('applicant')" align="center" width="100"/>
        ...
        <el-pagination :total="9" small layout="total, prev, pager, next, jumper"/>
      </div>
    </el-main>
  </div>
</template>
