<template>
  <el-card shadow="never">
    <div class="tool-common-wrap">
      ...
      <div class="btn-wrap">
        <el-button type="primary" @click="addList('添加用户权限')">
          {{ $t('add') }}
          <!---->
        </el-button>
      ...
      <el-row class="tr-body" type="flex" align="middle">
        ...
        <el-col style="text-align: center" :span="headers[2].span">
          <el-tooltip class="item" :content="$t('edit')">
            <el-button type="text" icon="el-icon-edit" @click="addList('编辑用户权限')"></el-button>
          </el-tooltip>
    ...
    <el-pagination
      ...
      :total="content.total"
    ></el-pagination>
    <admin-jurisdiction-dialog v-model="dialogVisible" :item = 'editItem' :title="linkTitle"/>
  </el-card>
</template>
<script>
import adminJurisdictionDialog from './adminJurisdictionDialog'
import QuickQuery from "@/bpm/components/quickquery/QuickQuery";
import SearchListMixin from "@/bpm/mixins/search_list_mixin";
export default {
  mixins: [SearchListMixin],
  components: {
    adminJurisdictionDialog,
    QuickQuery
  },
  data() {
    return {
