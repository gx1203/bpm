  ...
  <el-card id="internationalConfig" shadow="never">
    <div class="tool-common-wrap">
      <div class="search-wrap">
        <quick-query
          :placeholder="$t('placeholderText.multipleFieldsPlaceholder22')"
          :isDate="false"
          ref="quick"
    ...
    >
      <el-row>
        ...
        <!--        <el-col :span="8">-->
        <!--          <el-form-item :label="$t('deleteOrNot') + '：'">-->
        ...
        <div v-if="content.list && content.list.length!==0">
          <div class="tr" v-for="(item, index) in content.list" :key="index">
            ...
            <el-row class="tr-body" type="flex" align="middle">
              ...
              <!--            <el-col class="td" :span="headers[2].span">{{item.isdelete==="N"?'否':'是'}}</el-col>-->
              <el-col style="text-align: center" :span="headers[3].span">
                <el-tooltip class="item" :content="$t('edit')" placement="top">
                  <el-button type="text" icon="el-icon-edit" @click="companyHandle('edit',item)"></el-button>
                </el-tooltip>
      ...
      <div v-else>
        ...
        >
          ...
          <el-table-column
            ...
            prop="pname"
          />
          <!--          <el-table-column :label="$t('deleteOrNot')" show-overflow-tooltip sortable prop="isdelete" >-->
          <!--            <template slot-scope="scope">-->
          <!--              <div>{{scope.row.isdelete==="N"?'否':'是'}}</div>-->
          <!--            </template>-->
          <!--          </el-table-column>-->
...
<script>
import areaManageDialog from "./areaManageDialog";
    ...
    companyHandle(item, data) {
      ...
      if (item === "add") {
        ...
        this.dialogVisible = true;
          ...
          this.linkTitle = this.$t('editingArea')
