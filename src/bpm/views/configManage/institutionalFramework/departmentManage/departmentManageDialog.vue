<template>
  <el-dialog
    ...
    class="dialog_content_department"
    :title="title"
...
<script>
import { orgSave,queryOrgSuperior } from "@/bpm/api/configManage/institutionalFramework/org_info";
    ...
    return {
      ...
      rules: {
        name: [
          {
            required: true,
            message: this.$t("placeholderText.pleaseEnterDepartmentName"),
            trigger: "blur",
          },
        ],
        code: [
          {
            required: true,
            message: this.$t("placeholderText.pleaseEnterDepartmentCode"),
            trigger: "blur",
          },
        ],
        pname: [
