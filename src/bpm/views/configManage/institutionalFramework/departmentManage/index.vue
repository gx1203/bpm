  ...
  <el-card id="internationalConfig" shadow="never">
    <div class="tool-common-wrap">
      <div class="search-wrap">
        <quick-query
          :placeholder="$t('placeholderText.multipleFieldsPlaceholder23')"
          :isDate="false"
          ref="quick"
    ...
    >
      <el-row>
        <el-col :span="8">
          <el-form-item :label="$t('departmentCode') + '：'">
            <el-input clearable type="text" v-model="searchForm.code"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item :label="$t('departmentName') + '：'">
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        {
          key: "code",
          name: this.$t("departmentCode"),
          span: 4
        },
        {
          key: "name",
          name: this.$t("departmentName"),
          span: 6
        },
        {
          key: "pname",
  ...
  methods: {
    ...
    companyHandle(item, data) {
      // this.linkTitle = item;
      if (item === 'add') {
        this.linkTitle = this.$t("addDepartment")
        this.editItem = {
          hrtype: "2",
          subtype: "Y"
        };
        this.dialogVisible = true;
         ...
         this.linkTitle = this.$t("editDepartment")
