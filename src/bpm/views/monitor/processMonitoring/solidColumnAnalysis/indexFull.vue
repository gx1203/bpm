<template>
  <el-card id="solidColumnAnalysis" shadow="never" style="background: transparent;height: 1000px" >
    <el-form :model="searchForm" ref="searchForm" label-width="120px" size="mini" class="chartsBg1">
      <el-row>
        <el-col :span="8">
...
#solidColumnAnalysis {
  ...
  .chartsBg1 {
    height: 540px;
    position: relative;
    background: url("../../../../../bpa/assets/img/qietu/zdlc-cd.png") no-repeat;
