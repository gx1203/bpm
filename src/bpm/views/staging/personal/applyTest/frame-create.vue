<template>
  <div id="frame">
    <el-card style="margin-bottom:20px;">
      <h2 style="font-size: 20px;margin-bottom: 20px;">常用流程</h2>
    ...
    <el-card shadow="never" id="apply-create">
      <h2 style="font-size: 20px;margin-bottom: 20px;">全部流程</h2>
          ...
          <el-col :span="12">
            <el-form-item class="padding-l20" size="medium" label-width="85px" :label="$t('processName') + '：'">
              <div class="tool-common-wrap">
                ...
                <span v-show="boole" style="margin-left:20px;color:red;">没有搜索到相关的流程！</span>
              </div>
              ...
              <li v-for="(item2, index2) in item1.subNodes" :key="index2">
                ...
                <div class="cont">
                  <div v-for="(item3, index3) in item2.subNodes" :key="index3">
                    <h4 v-if="!item3.modelId" v-html="item3.name"></h4>
                    <div class="applylayout">
                      <P
                    ...
                    <div v-for="(item4, index4) in item3.subNodes" :key="index4">
                      <h5 v-html="item4.name"></h5>
                      <P
                        v-for="(items4, indexs3) in item3.processes"
                        :key="indexs3"
                        style="cursor: pointer;"
                        @click="toFlow(items4)"
                      >
