  ...
  <el-card shadow="never">
    <div class="tool-common-wrap">
      <div class="search-wrap">
        <quick-query :placeholder="$t('placeholderText.multipleFieldsPlaceholder3')" ref="quick" @quickSearch="quickSearch" />
      </div>
      <div class="btn-wrap">
    ...
    >
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item :label="$t('carbonCopyRecipients') + '：'">
        ...
        <el-col :span="8">
          ...
          <el-form-item :label="$t('state') + '：'">
              <el-select clearable type="text" class="w100" v-model="searchForm.status" :popper-append-to-body="false">
              <el-option :label="$t('all')" value="全部"></el-option>
              <el-option :label="$t('haveRead')" value="已读"></el-option>
              <el-option :label="$t('unread')" value="未读"></el-option>
            </el-select>
          </el-form-item>
        </el-col>
    ...
    <div class="tableWrap" v-loading="loading">
          ...
          <div class="tr" v-for="(item, index) in content.list" :key="index">
            ...
            <el-row class="tr-body" type="flex" align="middle">
              ...
              <el-col
                class="td textHide"
                :span="headers[3].span"
                :title="item.passReaderUserName"
              >{{item.passReaderUserName}}</el-col>
              <el-col
                class="td textHide"
                :span="headers[3].span"
                :title="item.status"
      ...
      <div v-else>
        ...
        >
          ...
          <el-table-column :label="$t('carbonCopyRecipients')" show-overflow-tooltip sortable prop="passReaderUserName">
            <template slot-scope="scope">
    ...
    return {
      ...
      headers: [
        ...
        },
        {
          ...
          name: this.$t('carbonCopyRecipients'),
          span: 4
        },
        {
          name: this.$t('state'),
  ...
  methods: {
    ...
    quickQueryData() {
      ...
      passreadtome({
        ...
        queryFilter: ['reqNo','attribute1','subject','drafter','passReaderUserName'],
        ...this.quickData,
        ...this.sort,
        ...this.page
      })
