<template>
  <el-card shadow="never">
      ...
      <div class="tr-title">
       ...
       <el-row class="tr-body" type="flex" align="middle">
        ...
        <el-col style="text-align: center" :span="headers[5].span">
          <el-button type="text" icon="el-icon-edit" @click="addList($t('editDataDictionary'),item)"></el-button>
          <el-button type="text" icon="el-icon-delete"></el-button>
          <el-button type="text" @click="setList(item)">配置选项</el-button>
        </el-col>
      </el-row>
    </div>
    </div>
    ...
    <data-dictorary-dialog v-model="dialogVisible" :item="editItem" :title="linkTitle" @confirm="saveSuccess"/>
    <set-select-dialog v-model="dialogVisibleSet" :item="setItem" @confirm="saveSetSuccess"/>
  </el-card>
</template>
